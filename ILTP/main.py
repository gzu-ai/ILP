...
if __name__ == "__main__":
    ...
    type_file_dict = {'optimalBound':'MHSC','optimalLeast':'MHSC-uniform','optimalConstraintR':'R-ILTP','optimalConstraintSP':'SP-ILTP','specificTrimed':'ILTP',
                      ...
                      'optimalApplicableSP':'SP-ILTP-app', 'optimalBoundSep':'MHSC-head',
                      'optimalLeastSPSep': 'SP-MHSC-uniform-head', 'optimalLeastSep':'MHSC-uniform-head',
                      'optimalLeastASep': 'A-MHSC-uniform-head', 'optimalLeastSSep': 'S-MHSC-uniform-head',
