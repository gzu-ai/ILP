...
if __name__ == "__main__":
    GRN_name = 'mammalian'
    num_of_Is = 4000 #{40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480}
    ...
    GRN_name_list = [ 'budding'] #'mammalian', 'fission', 'budding', 'arabidopsis', 'thelper', 'tcrNet'
    ...
    Is_amount_list = [ 4000, 4500] #  [500, 1500, 2000, 2500] [3000, 3500, 4000, 4500, 5000] [720, 800]
    ...
    t = 4
    tmp_examples_asp_dir = examples_asp_dir + '/trim0309'
    tmp_background_asp_dir = background_asp_dir + '/trim0309'
