...
if __name__ == "__main__":
    ...
    search_type_list = 'optimalApplicableSP'
    silent_level = 5
    file_name = 'log.log'
    ...
    GRN_name_list = ['thelper','arabidopsis',  'budding', 'fission', 'mammalian'] #['tcrNet', 'thelper','arabidopsis',  'budding', 'fission', 'mammalian'] 不确定边界时，倒序更合理
